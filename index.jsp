...
<body>
    ...
    <div class="mainContainer">
     <form action="MyServlet" method="post" class="searchInput">
            <input type="text" placeholder="Enter City*" id="searchInput"  name="city"/>
            <input type="submit" id="searchButton" value="search">
            
      </form>
      <div class="pp">
           <center> <small>*If you want to check the weather of <br>
            other cities then click here </small></center></div>
            
        <div class="weatherDetails">
            <div class="weatherIcon">
                
                
            <div class="t">    <h2>${temperature} °C</h2></div>
                 <input type="hidden" id="wc" value="${weatherCondition}"> </input>
            </div>
            
            <div class="cityDetails">        
                <div class="desc"><h5>${city}</h5></div>
